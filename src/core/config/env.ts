...
const config: Config = {
  ...
  GARDENOVA_PLANTAPI_KEY: getEnv("GARDENOVA_PLANTAPI_KEY"),
  GARDENOVA_PLANTAPI_URL: getEnv("GARDENOVA_PLANTAPI_URL"),
  GARDENOVA_PLANTAPI_KEY_NAME: getEnv("GARDENOVA_PLANTAPI_KEY_NAME"),
